...
build/src/inode_table.o: src/inode_table.c include/inode_table.h include/disk.h include/inode.h include/common.h | build/src
	$(CC) $(CFLAGS) -c src/inode_table.c -o build/src/inode_table.o

build/src/fs_alloc.o: src/fs_alloc.c include/fs_alloc.h include/disk.h include/bitmap.h include/common.h | build/src
...
build/tests/test_disk.o: tests/test_disk.c tests/test_disk.h include/disk.h include/common.h | build/tests
	$(CC) $(CFLAGS) -c tests/test_disk.c -o build/tests/test_disk.o

build/tests/test_superblock.o: tests/test_superblock.c tests/test_superblock.h include/superblock.h include/disk.h include/common.h | build/tests
	$(CC) $(CFLAGS) -c tests/test_superblock.c -o build/tests/test_superblock.o

build/tests/test_bitmap.o: tests/test_bitmap.c tests/test_bitmap.h include/bitmap.h include/common.h | build/tests
	$(CC) $(CFLAGS) -c tests/test_bitmap.c -o build/tests/test_bitmap.o

build/tests/test_inode.o: tests/test_inode.c tests/test_inode.h include/inode.h include/common.h | build/tests
	$(CC) $(CFLAGS) -c tests/test_inode.c -o build/tests/test_inode.o

build/tests/test_inode_table.o: tests/test_inode_table.c tests/test_inode_table.h include/inode_table.h include/disk.h include/inode.h include/common.h | build/tests
	$(CC) $(CFLAGS) -c tests/test_inode_table.c -o build/tests/test_inode_table.o

build/tests/test_fs_alloc.o: tests/test_fs_alloc.c tests/test_fs_alloc.h include/disk.h include/bitmap.h include/common.h | build/tests
